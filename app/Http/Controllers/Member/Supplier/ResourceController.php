...
class  ResourceController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.supplier.resource.index', compact('lists'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    return redirect('/member/supplier/resource/create')
                        ->withInput()
                ...
                $resource->save();
                if ($resource) {
                    return redirect('/member/supplier/resource')->withSuccess('保存成功！');
                } else {
                    return Redirect::back()->withErrors('保存失败！');
                }
            }
            $suppliers = Supplier::all();
            return view('member.supplier.resource.create', compact('resource', 'suppliers'));
        } catch (Exception $ex) {
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            $suppliers = Supplier::all();
            $scenics = Scenic::all();
            return view('member.supplier.resource.edit', compact('resource', 'suppliers', 'scenics'));
        } catch (Exception $ex) {
            return Redirect::back()->withInput()->withErrors('异常！' . $ex->getMessage());
        }
    }
    ...
    public function detail($id, Request $request)
    {
        try {
            ...
            $resource = Supplier_Resource::find($id);
            if (!$resource) {
                return redirect('/member/supplier/resource')->withErrors('数据加载失败！');
            }

            return view('member.supplier.resource.detail', compact('resource'));
        } catch (Exception $ex) {
            return Redirect::back()->withInput()->withErrors('异常！' . $ex->getMessage());
        }
    }
    ...
    public function delete($id, Request $request)
    {
        try {
            ...
            $scenic = Scenic::all();
            return view('member.supplier.resource.create', compact('resource', 'supplier', 'scenic'));
        } catch (Exception $ex) {
            return Redirect::back()->withInput()->withErrors('异常！' . $ex->getMessage());
        }
    }
    ...
    public function sync($id, Request $request)
    {
        try {
            ...
            return redirect('/member/supplier/resource/' . $id)->withSuccess('同步成功！');
        } catch (Exception $ex) {
