...
class TemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.supplier.template.index', compact('lists'));
    }
    ...
    public function create($id, Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    return redirect('/member/supplier/resource/template/create/')
                        ->withInput()
                ...
                $template->save();
                if ($template) {
                    return redirect('/member/supplier/resource/detail/' . $id . '?tab=template')->withSuccess('保存成功！');
                }
            ...
            $template->resourceId = $id;
            return view('member.supplier.resource.template.create', compact('template', 'enterprises'));
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            return view('member.supplier.resource.template.edit', compact('template'));
    ...
    public function delete($id, Request $request)
    {
        try {
            $template = Supplier_Resource_Template::find($id);
            $template->delete();
            return redirect('/member/supplier/resource/detail/' . $template->resourceId . '?tab=template')->withSuccess('删除成功！');
