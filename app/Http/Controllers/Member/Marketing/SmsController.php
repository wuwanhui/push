...
namespace App\Http\Controllers\Member\Marketing;
        ...
        try {
            if ($request->isMethod('POST')) {
                ...
                if (property_exists($resp, 'result')) {
                    return redirect('member/sms/create/')->withSuccess('发送成功！');
                }
                //失败返回
