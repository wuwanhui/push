...
class PaymentsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.finance.payments.index', compact('lists'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    echo "效验失败";
                    return redirect('/member/finance/payments/create')
                        ->withInput()
                ...
                $payments->save();
                if ($payments) {
                    return redirect('/member/finance/payments')->withSuccess('保存成功！');
                }
            ...
            return view('member.finance.payments.create', compact('payments', 'accounts', 'users'));
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            return view('member.finance.payments.edit', compact('payments'));
