...
class CreditController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.finance.credit.index', compact('lists'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    echo "效验失败";
                    return redirect('/member/finance/credit/create')
                        ->withInput()
                ...
                $credit->save();
                if ($credit) {
                    return redirect('/member/finance/credit')->withSuccess('保存成功！');
                }
            ...
            return view('member.finance.credit.create', compact('credit', 'users'));
