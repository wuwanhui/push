...
class InvoiceController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manage.finance.invoice.index', compact('lists'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    echo "效验失败";
                    return redirect('/manage/finance/invoice/create')
                        ->withInput()
                ...
                if ($invoice) {
                    return redirect('/manage/finance/invoice')->withSuccess('保存成功！');
                }
            ...
            return view('manage.finance.invoice.create', compact('invoice'));
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    echo "效验失败";
                    return redirect('/manage/finance/invoice/edit')
                        ->withInput()
                        ->withErrors($validator);
                }
            ...
            return view('manage.finance.invoice.edit', compact('invoice', 'users'));
    ...
    public function transfer(Request $request)
    {
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    echo "效验失败";
                    return redirect('/manage/finance/invoice/transfer')
                        ->withInput()
                        ->withErrors($validator);
                }
            ...
            return view('manage.finance.invoice.transfer', compact('invoice', 'users'));
