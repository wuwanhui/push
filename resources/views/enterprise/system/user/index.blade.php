        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            <li>
                                <a href="{{url('/member/system/config')}}">系统参数</a>
                            </li>
                            <li>
                                <a href="{{url('/member/system/user')}}" class="active">用户管理</a>
                            </li>
                            <li>
                                <a href="{{url('/member/system/base')}}">基础数据</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/system/user/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/supplier/scenic/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/supplier/scenic/delete/'.$item->id)}}">删除</a>
