        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            <li>
                                <a href="{{url('/member/open/apply')}}" class="active">应用管理</a>
                            </li>
                            <li>
                                <a href="{{url('/member/open/api')}}">接口开放</a>
                            </li>
                            <li>
                                <a href="{{url('/member/open/ota')}}">OTA对接</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/open/apply/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr >
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/open/apply/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/open/apply/delete/'.$item->id)}}">删除</a> |
                                            <a href="{{url('/member/open/apply/test/'.$item->id)}}">测试</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
