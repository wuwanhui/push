        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul>
                            <li>
                                <a href="{{url('/member/supplier')}}">供应商列表</a>
                            </li>
                            <li>
                                <a href="{{url('/member/supplier/product')}}">原始资源</a>
                            </li>
                        ...
                        <ul>
                            <li>
                                <a href="{{url('/member/supplier/scenic')}}">景区配置</a>
                            </li>
                            <li>
                                <a href="{{url('/member/supplier/produits')}}" class="active">产品中心</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/supplier/produits/create/'.request('id'))}}"
                            ...
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                @foreach($lists as $item)
                                    <tr >
                                        ...
                                        <td>
                                            <a href="{{url('/member/produits/?scenicId='.$item->scenicId)}}">{{$item->scenic->name}}</a>
                                        </td>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/supplier/produits/edit/'.$item->id)}}">编辑</a>
                                            | <a
                                                    href="{{url('/member/supplier/produits/delete/'.$item->id)}}">删除</a>
                                            <hr/>
                                            <a href="{{url('/member/supplier/produits/rule?produitsId='.$item->id)}}">预定规则</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
