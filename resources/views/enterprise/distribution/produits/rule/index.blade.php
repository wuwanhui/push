        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/supplier/produits/rule/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr >
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/supplier/produits/rule/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/supplier/produits/rule/delete/'.$item->id)}}">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
