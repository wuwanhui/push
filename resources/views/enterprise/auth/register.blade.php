        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/enterprise/register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('shortName') ? ' has-error' : '' }}">
                            <label for="shortName" class="col-md-4 control-label">简称</label>
                        ...
                        <div class="form-group{{ $errors->has('linkMan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="linkMan" type="text" class="form-control" name="linkMan" value="{{ old('linkMan') }}" required>
