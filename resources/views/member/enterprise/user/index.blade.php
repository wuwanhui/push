        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/enterprise/user/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/enterprise/user/edit/'.$item->id)}}">编辑</a>
                                            @if($item->type==1)
                                                |
                                                <a href="{{url('/member/enterprise/user/delete/'.$item->id)}}">删除</a>
                                            @endif
