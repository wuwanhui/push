        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul>
                            <li>
                                <a href="{{url('/member/member')}}">会员管理</a>
                            </li>
                            <li>
                                <a href="{{url('/member/member/order')}}" class="active">订单管理</a>
                            </li>
                        ...
                        <ul>
                            <li>
                                <a href="{{url('/member/supplier/scenic')}}">会员统计</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/member/order/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/member/order/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a
                                                    href="{{url('/member/member/order/delete/'.$item->id)}}">删除</a>
