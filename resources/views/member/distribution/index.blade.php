        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            <li>
                                <a href="{{url('/member/distribution')}}" class="active">分销商管理</a>
                            </li>
                            <li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/distribution/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/distribution/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/distribution/delete/'.$item->id)}}">删除</a>
                                            <hr/>
                                            <a
                                                    href="{{url('/member/finance/credit?distributionId='.$item->id)}}">授信</a>
                                            | <a
                                                    href="{{url('/member/distribution/sales?distributionId='.$item->id)}}">授权</a>
                                            | <a
                                                    href="{{url('/member/open/apply?distributionId='.$item->id)}}">应用</a>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-4"><a
                                        href="{{url('/member/distribution/delete')}}"
