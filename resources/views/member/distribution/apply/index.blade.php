        ...
        <div class="row">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            ...
                            <li>
                                <a href="{{url('/member/distribution/credit')}}">授信管理</a>
                            </li>
                            <li>
                                <a href="{{url('/member/distribution/apply')}}" class="active">应用中心</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/distribution/apply/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/distribution/apply/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/distribution/apply/delete/'.$item->id)}}">删除</a> |
                                            <a href="{{url('/member/distribution/apply/test/'.$item->id)}}">测试</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
