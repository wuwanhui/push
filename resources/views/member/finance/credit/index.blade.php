        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        ...
                        <ul>
                            <li>
                                <a href="{{url('/member/finance/credit')}}" class="active">授信管理</a>
                            </li>
                        </ul>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/finance/credit/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/finance/credit/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/finance/credit/delete/'.$item->id)}}">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-4"><a
                                        href="{{url('/member/finance/create/delete')}}"
