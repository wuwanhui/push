        ...
        <div class="row">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            ...
                            <li>
                                <a href="{{url('/member/finance/invoice')}}" class="active">发票申请</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/finance/invoice/create')}}"
                                                     class="btn btn-primary">申请</a></div>
                        ...
                        <fieldset>
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                <tr style="text-align: center" class="text-center">
                                    ...
                                    <th style="width: 100px;"><a href="">申请用户</a></th>
                                ...
                                @foreach($lists as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/finance/invoice/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/finance/invoice/delete/'.$item->id)}}">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-4"><a
                                        href="{{url('/member/finance/invoice/delete')}}"
