        ...
        <div class="row">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body ">
                        <ul>
                            ...
                            <li>
                                <a href="{{url('/member/distribution/sales')}}" class="active">产品授权</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4"><a href="{{url('/member/distribution/sales/create')}}"
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/member/distribution/create/edit/'.$item->id)}}">编辑</a>
                                            |
                                            <a href="{{url('/member/distribution/create/delete/'.$item->id)}}">删除</a>|
                                            <a href="{{url('/member/distribution/create/delete/'.$item->id)}}">政策</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
