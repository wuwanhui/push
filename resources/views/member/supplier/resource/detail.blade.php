                                    ...
                                    @foreach($resource->signatures as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center"><a
                                                        href="{{url('/member/supplier/resource/signature/edit/'.$item->id)}}">编辑</a>
                                                | <a
                                                        href="{{url('/member/supplier/resource/signature/delete/'.$item->id)}}">删除</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                        ...
                                        <td colspan="100">
                                            <div class="row" style="padding: 10px;">
                                                <div class="col-md-4"><a
                                                            href="{{url('/member/supplier/resource/signature/create/'.$resource->id)}}"
                                ...
                                <table class="table table-bordered table-hover  table-condensed">
                                    ...
                                    @foreach($resource->templates as $item)
                                        <tr >
                                            ...
                                            <td style="text-align: center"><a
                                                        href="{{url('/member/supplier/resource/template/edit/'.$item->id)}}">编辑</a>
                                                | <a
                                                        href="{{url('/member/supplier/resource/template/delete/'.$item->id)}}">删除</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                    ...
                                    <tr>
                                        <td colspan="100">
                                            <div class="row" style="padding: 10px;">
                                                <div class="col-md-4"><a
                                                            href="{{url('/member/supplier/resource/template/create/'.$resource->id)}}"
                                                            class="btn btn-primary">新增</a></div>
                                                <div class="col-md-8 text-right">
    ...
    <script type="application/javascript">
        ...
        $(function () {
            ...
            $("#supplierId").click(function () {
                ...
                $.ajax({
                    url: "{{url('/member/supplier/resource/supplier')}}",
                    type: "post",
                    dataType: "json",
                    timeout: 30000,
                    headers: {
            ...
            $("#scenicId").click(function () {
                ...
                $.ajax({
                    url: "{{url('/member/supplier/resource/scenic')}}",
                    type: "post",
                    dataType: "json",
                    timeout: 30000,
                    headers: {
