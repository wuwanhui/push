                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul>
                            ...
                            <li>
                                <a href="{{url('/member/supplier/product')}}" class="active">原始资源</a>
                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{url('/member/supplier/produits')}}">产品中心</a>
                            </li>
            ...
            <div class="col-md-10">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="{{url('/member/supplier/product/create')}}"
                            ...
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                @foreach($lists as $item)
                                    <tr title="{{$item->attention}}">
                                        ...
                                        <td><a
                                                    href="{{url('/member/supplier/product/edit/'.$item->id)}}">编辑</a> | <a
                                                    href="{{url('/member/supplier/product/delete/'.$item->id)}}">删除</a>
                                            <hr/>
                                            <a href="{{url('/member/supplier/produits/original/'.$item->id)}}">加入产品中心</a>
